                  ...
                  <div class="col-md-12">
                     <div class="breadcromb-box-pagin">
                        <ul>
						   ...
						   <li class="active-breadcromb"><a href="loginemployer.html">Perusahaan</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
...
if(isset($_POST["new_pass"])){
    ...
    $query = mysqli_query($koneksidb, "UPDATE perusahaan SET password = '$modEnkrip' WHERE email = '$email'");
    if($query){
	...
	echo "<meta http-equiv='refresh' content='2; url=loginemployer.html'>";
